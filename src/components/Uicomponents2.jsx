...
const palettes = [
  ...
  [
    "#b9e1dc", "#6fcfc6", "#3a8888", "#2f6e6e", "#1c6464", "#0f4a4a", "#0a3333", "#062020",
  ],
  [
    "#031c32", "#043456", "#064570", "#075e90", "#0772b0", "#1999d3", "#68b8e0", "#cfd9df",
  ],
  [
    "#1a1a1a", "#2c3e50", "#3e5870", "#f39c12", "#e67e22", "#d35400", "#c0392b", "#992d22",
  ],
];
            ...
            <div className="flex gap-5">
              {uiThemes.map((themeObj, idx) => (
                ...
                >
                  ...
                  />
                  <div className="px-2 py-2 text-center mt-2">{themeObj.title}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mb-10 pl-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              <div
                ...
                className="flex items-center justify-center border rounded-lg h-34 cursor-pointer hover:border-blue-500 overflow-hidden"
              >
                {customImage ? (
                  <img src={customImage} alt="Custom" className="h-24 w-full object-cover" />
                ) : (
